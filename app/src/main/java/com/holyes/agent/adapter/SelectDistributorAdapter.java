...
/**
 * @ClassName: SelectDistributorAdapter
 * @Description:  点击菜单界面列表的ExpandableListView的适配器
 * @Author: lijin
 * @Date: 2021/3/5 17:26
 */
public class SelectDistributorAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener {
         ...
         */
        public SelectDistributorAdapter(Context context, List<Retailer> menuGroups) {
        ...
        class ChildItemClick implements View.OnClickListener
        {
            ...
            public void onClick(View v) {
                ...
                ((SelectCompanyStoreInfor)context).goToOutStock(storeInfor);
            }
