 ...
 * @Date: 2021/3/10 9:55
 */
public class QueryScanBatchDetail extends Activity {
    AccessWeb accWeb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_query_scan_batch_detail);
...
//		et_search.addTextChangedListener(new EditTextChnangeListener());
        ...
        MyProgressDialog.show(QueryScanBatchDetail.this, "", true, true);
...
//                Log.d("main",slist.toString());
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    MyProgressDialog.close();
                    ShowMessage.Show(QueryScanBatchDetail.this, msg.obj.toString());
                    break;
    ...
    private void initListView(List<Map<String, Object>> mList) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(QueryScanBatchDetail.this, mList,
                R.layout.list_purcheck_batch_detail, new String[]{"goodsid", "modelm", "colors", "curcount","batchno"},

                new int[]{R.id.txt_list1, R.id.txt_list2, R.id.txt_list3, R.id.txt_list4,R.id.txt_batch});
