    ...
    private class GetDateRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                slist = accWeb.GetDowLoadLensBillDetail(sysUserInfo.getLoginid(), mBillNo);
...
//        Collections.sort(mList, new SortListMapComparator("modelm"));
        ...
        SimpleAdapter adapter = new SimpleAdapter(QueryScanLensDetail.this, mList,
                R.layout.list_scan_lens_detail, new String[]{"product_id", "RefractiveIndex", "Diopter", "Astigmatism", "Num"},
