...
import com.holyes.headquarter.other.P_Dv_InStock_Z_ChangeStock_NoBill;
...
public class SelectInStock extends Activity {
    ...
    private class listViewClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = null;
            intent = new Intent(SelectInStock.this, P_Dv_InStock_Z_ChangeStock_NoBill.class);
            ...
            intent.putExtra("instock_id", (String) item.get("stock_id"));
            intent.putExtra("instock_name", (String) item.get("stock_name"));
