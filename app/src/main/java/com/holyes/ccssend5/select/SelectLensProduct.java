        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    list = accWeb.GetDownLoadGoodsLensInfor(et_search.getText().toString().trim());
...
//        Collections.sort(mList, new SortListMapComparator("PurOrderNo"));
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, mList, R.layout.list_goods_lens_detail,
                new String[]{"GoodsId", "GoodsDescription", "RefractiveIndex"}, new int[]{R.id.txt_list1, R.id.txt_list2, R.id.txt_refractivity});
