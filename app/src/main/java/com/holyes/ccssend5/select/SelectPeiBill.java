    ...
    private class ListViewItemClik implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (lsv_aim.equals("P_Dv_ReturnedPurchase_Z_D_Bill")
                ...
                intent.putExtra("title", "确定选择配货单：" + item.get("purchecklno")
                        + "的产品吗？");
            }
        ...
        public void run() {
            ...
            try {
                ...
                //有单无明细代销退货||有单有明细代销退货||退货直通车
                        ...
                        || lsv_aim.equals("P_Dv_ReturnedPurchase_Z_D_Bill_Detail")
                        || lsv_aim.equals("P_Dv_L_Return_Z_Bill")
                        || lsv_aim.equals("P_Dv_ReturnedMendLabel_Z_D_HaveNoBill")) {
                    list = accWeb.GetDowLoadAgentReturnBill();
                }
                //有单无明细直营退货\\有单有明细直销退货
                ...
                case ShowMessage.HandSuccess:
                    ...
                    if (list.size() > 0) {
                        ...
                        for (Map<String, Object> map : list) {
                            purchecklno = (String) map.get("PeiGoodLno");
                            saplno = (String) map.get("SapLno");
                            supplier_na = (String) map.get("AgentName");
                            stock_name = (String) map.get("StockName");
                            supplier_id = (String) map.get("AgentId");
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == 0) {
                ...
                if (lsv_aim.equals("P_Dv_OutStock_Z_D_Bill_BeInStock")) {
                    intent = new Intent(SelectPeiBill.this, P_Dv_OutStock_Z_D_Bill_BeInStock.class);
                }
                //有单无入库代销发货
