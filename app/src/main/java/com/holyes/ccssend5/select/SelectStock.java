...
import com.holyes.headquarter.backgoods_d.P_Dv_ReturnedPurchase_Z_D_NoBill;
...
import com.holyes.headquarter.other.P_Dv_MendLable_Z;
import com.holyes.headquarter.sendgoods_d.P_Dv_OutStock_Z_D_NoBill_BeInStock;
import com.holyes.headquarter.sendgoods_d.P_Dv_OutStock_Z_D_NoBill_NoInStock;
import com.holyes.headquarter.sendgoods_zy.P_Dv_OutStock_Z_L_NoBill_BeInStock;
import com.holyes.headquarter.sendgoods_zy.P_Dv_OutStock_Z_L_NoBill_NoInStock;
    ...
    private class listViewClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            //直营有入库无单发货
                ...
                intent = new Intent(SelectStock.this, P_Dv_OutStock_Z_L_NoBill_BeInStock.class);
            }
            //总公司仓库补标
            ...
            //代理无单退货
                ...
                intent = new Intent(SelectStock.this, P_Dv_ReturnedPurchase_Z_D_NoBill.class);
            }
            ...
            //直营分销店退货
            else if (lsv_aim.equals("P_Dv_ReturnedPurchase_Z_S_NoBill")) {
                storeInfor = (StoreInfor) getIntent().getSerializableExtra("selectedStoreInfor");
                intent = new Intent(SelectStock.this, P_Dv_ReturnedPurchase_Z_S_NoBill.class);
                intent.putExtra("selectedStoreInfor", storeInfor);
            }
