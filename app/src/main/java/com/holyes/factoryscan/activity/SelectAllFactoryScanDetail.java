...
/**
 * @ClassName: SelectFactoryScanDetail
 * @Description: 所有用户装盒明细函数
 * @Author: lijin
 * @Date: 2025年8月6日17:08:53
 */
public class SelectAllFactoryScanDetail extends Activity {
...
//        private TextView tv_total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_allfactoryscandetail);
        mContext = this;
...
//        dList=new ArrayList<>();
    ...
    public void initListView(List<Map<String, Object>> dataList) {
        adapter = new SimpleAdapter(this, dataList, R.layout.list_allfactoryscandetail,
                new String[]{"UserName","BoxDate", "GoodsName", "BoxNum", "GoodsNum",
                }, new int[]{R.id.list_goods_user,
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    ...
                    ShowMessage.Show(SelectAllFactoryScanDetail.this, msg.obj.toString());
                    break;
                case ShowMessage.HandSuccess: // 返回成功
                    ...
                    if (dList.size()>0){
                        ...
                        ShowMessage.Show(SelectAllFactoryScanDetail.this, "未查询到数据");
                    }
                    break;
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Gson gson=new Gson();
                    dList=new ArrayList<>();
                    dList = accWeb.GetAllPackingBoxDeail(gson.toJson(boxPackDate));
