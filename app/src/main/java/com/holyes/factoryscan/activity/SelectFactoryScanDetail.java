 ...
 * @Date: 2025/8/1 17:30
 */
public class SelectFactoryScanDetail extends Activity {
...
//        private TextView tv_total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selectfactoryscandetail);
        mContext = this;
...
//        dList=new ArrayList<>();
    ...
    public void initListView(List<Map<String, Object>> dataList) {
        adapter = new SimpleAdapter(this, dataList, R.layout.list_factoryscandetail,
                new String[]{"BoxDate", "GoodsName", "BoxNum", "GoodsNum",
                }, new int[]{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    ...
                    ShowMessage.Show(SelectFactoryScanDetail.this, msg.obj.toString());
                    break;
                case ShowMessage.HandSuccess: // 返回成功
                    ...
                    if (dList.size()>0){
                        ...
                        ShowMessage.Show(SelectFactoryScanDetail.this, "未查询到数据");
                    }
                    break;
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Gson gson=new Gson();
                    dList=new ArrayList<>();
                    dList = accWeb.GetOwnPackingBoxDeail(gson.toJson(boxPackDate));
