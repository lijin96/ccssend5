...
/**
 * @ClassName: CheckMenuListViewAdapter
 * @Description: 勾选菜单界面的ExpandableListView的适配器
 * @Author: lijin
 * @Date: 2021/3/10 10:17
 */
public class CheckMenuListViewAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener{
         ...
         */
        public CheckMenuListViewAdapter(Context context, ArrayList<MenuGroup> menuGroups) {
