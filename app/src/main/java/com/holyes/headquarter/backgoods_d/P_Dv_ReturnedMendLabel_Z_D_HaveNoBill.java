...
/**
 * @ClassName: P_Dv_ReturnedMendLabel_Z_D_HaveNoBill
 * @Description: 代销退货补标函数
 * @Author: lijin
 * @Date: 2021/3/10 10:21
 */
public class P_Dv_ReturnedMendLabel_Z_D_HaveNoBill extends Activity {
    ...
    private TextView tv_curqty, tv_totalqty, tv_company_name, tv_model_colors, tv_goodsid;
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_dv_returnedmendlabel_z_d_havenobill);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedMendLabel_Z_D_HaveNoBill.this, "         无单代销退货", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedMendLabel_Z_D_HaveNoBill", para.toJson());
