...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Lens_Z_D_NoBill
 * @Description: 镜片有单无明细代销退货
 * @Author: lijin
 * @Date: 2024/6/7 16:04
 */
public class P_Dv_ReturnedPurchase_Lens_Z_D_Bill extends Activity {
    ...
    private TextView tv_curqty, tv_totalqty, tv_company_name,
            tv_billno, tv_model_colors, tv_stock_name, tv_goodsid,tv_source_billno;
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_lens_z_d_bill);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.printLens(P_Dv_ReturnedPurchase_Lens_Z_D_Bill.this, "镜片无单代销发货退回", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
...
//                    para.setSourceBillNo("");
                    ...
                    para.setBarcode(contents);
                    para.setGoodsId("");//>>>goodsid
                    para.setSoCompId(supplier_id);//>>>supplier_id
                    para.setDeCompId("00");
                    para.setOaSuserId(sysUserInfo.getUserid());
                    para.setStockId(stock_id);//>>>stock_id
                    para.setScanSn(String.valueOf(nSize));
                    para.setScanBillNo(scanBillno);
                    para.setBillNo(mBillNo);
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_D_Lens_Bill", para.toJson());
//                    Log.d("main",result);
                    if (result == "") {
                        MySound.errorSound();
