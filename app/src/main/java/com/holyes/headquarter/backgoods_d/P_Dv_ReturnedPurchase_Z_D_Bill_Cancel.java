...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_D_Bill_Cancel
 * @Description: 有单无明细代销退货撤销
 * @Author: lijin
 * @Date: 2021/3/10 10:21
 */
public class P_Dv_ReturnedPurchase_Z_D_Bill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_d_bill_cancel);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    mark[0] = "退货撤销单：" + mBillNo;
                    //			mark[2] = "仓   库 ："+tv_stock_name.getText().toString();

                    printbill.print(P_Dv_ReturnedPurchase_Z_D_Bill_Cancel.this, "    有单无明细代销退货撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    para.setStockId("");
                    para.setScanSn(String.valueOf(nScanCount));
                    para.setScanBillNo(scanBillno);
                    para.setBillNo("");
                    para.setSourceBillNo("");

                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_D_Bill_Cancel", para.toJson());
