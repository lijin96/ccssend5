...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_D_Bill_Detail
 * @Description: 有单有明细(代销)退回函数
 * @Author: lijin
 * @Date: 2021/3/10 10:21
 */
public class P_Dv_ReturnedPurchase_Z_D_Bill_Detail extends Activity {
...
//	Thread send ;
    ...
    private Button btn_returnedpurchase_revoke;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_d_bill_detail);
...
//		send.start();
        ...
        btn_returnedpurchase_revoke = (Button) findViewById(R.id.btn_returnedpurchase_revoke);
        btn_returnedpurchase_revoke.setOnClickListener(new View.OnClickListener() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedPurchase_Z_D_Bill_Detail.this, "    有单有明细代销退货", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_D_Bill_Detail", para.toJson());
