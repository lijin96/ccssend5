...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_D_Bill_Detail_Cancel
 * @Description: 有单有明细(代销)退回撤消
 * @Author: lijin
 * @Date: 2021/3/10 10:22
 */
public class P_Dv_ReturnedPurchase_Z_D_Bill_Detail_Cancel extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_d_bill_detail_cancel);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedPurchase_Z_D_Bill_Detail_Cancel.this, " 有单有明细代销退货撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_D_Bill_Detail_Cancel", para.toJson());
