...
/**
 * @ClassName: P_Dv_ReturnedMendLabel_Z_L_HaveNoBill
 * @Description: 直销退货补标函数
 * @Author: lijin
 * @Date: 2021/3/10 10:23
 */
public class P_Dv_ReturnedMendLabel_Z_L_HaveNoBill extends Activity {
    ...
    //当前产品型号数量，合计数量，直营店名称，型号色号，产品代号
    private TextView tv_curqty, tv_totalqty, tv_supplier_name, tv_model_colors, tv_goodsid;
    private EditText et_barcode;//条码输入框
    private TextView tv_show_code;//显示当前扫描的条码

    private TextView tv_havenobill_source_billno;//销售配货单
    private TextView tv_havenobill_billno;//退货单

    private Button btn_select_goodsid;//选择产品

    private TextView tv_stock_name;//仓库


    //打印的明细集合
    private List<Map<String, Object>> sacnDataList = new ArrayList<Map<String, Object>>();

    private String scanBillno = "", mBillNo = "", company_id = "", supplier_name = "", sourceBillNo = "";
    private String curcount = "0", goodsid = "", stock_id = "", stock_name, CancelscanBillno = "";
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_dv_returnedmendlabel_z_l_havenobill);
        ...
        tv_havenobill_billno = (TextView) findViewById(R.id.tv_havenobill_billno);
        tv_model_colors = (TextView) findViewById(R.id.tv_model_colors);
        tv_havenobill_source_billno = (TextView) findViewById(R.id.tv_havenobill_source_billno);
        ...
        scanBillno = sysUserInfo.getUserid() + "1T" + SomeUtils.RandomScanOrder();// 系统
        sysUserInfo.setIsDownload(true);

        tv_totalqty.setText("0");
        tv_curqty.setText("0");
        tv_havenobill_billno.setText("");
        tv_supplier_name.setText(supplier_name);
        tv_stock_name.setText(stock_name);
        tv_havenobill_source_billno.setText(sourceBillNo);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case ShowMessage.HandScanSuccess:
                    ...
                    if (tv_havenobill_billno != null) {
                        tv_havenobill_billno.setText(mBillNo);
                    }
                ...
                case 8:
                    ...
                    mark[0] = "退货单：" + mBillNo;
                    mark[1] = "代理商：" + tv_supplier_name.getText().toString();
                    mark[2] = "仓   库 ：" + tv_stock_name.getText().toString();

                    printbill.print(P_Dv_ReturnedMendLabel_Z_L_HaveNoBill.this, "         无单代销退货", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedMendLabel_Z_L_HaveNoBill", para.toJson());
