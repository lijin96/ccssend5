...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Lens_Z_L_Bill_Cancel
 * @Description: 镜片有单无明细直销退货撤销
 * @Author: lijin
 * @Date: 2024/6/7 17:24
 */
public class P_Dv_ReturnedPurchase_Lens_Z_L_Bill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_lens_z_l_bill_cancel);
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    printbill.printLens(P_Dv_ReturnedPurchase_Lens_Z_L_Bill_Cancel.this, "镜片无单直销退回撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_Lens_Bill_Cancel", para.toJson());
