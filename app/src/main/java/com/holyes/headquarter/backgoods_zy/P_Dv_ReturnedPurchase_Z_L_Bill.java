...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_L_Bill
 * @Description: 有单无明细直销退货
 * @Author: lijin
 * @Date: 2021/3/10 10:23
 */
public class P_Dv_ReturnedPurchase_Z_L_Bill extends Activity {
    ...
    private String modelm = "", colors = "",batch_num="";//上传的批次号
    private String showbatch_num="";//展示的批次号
    ...
    private Button btn_p_dv_returnedpurchase_z_l_bill_revoke;//撤销
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_l_bill);
...
//        btn_p_dv_returnedpurchase_z_l_bill_revoke = (Button) findViewById(R.id.btn_p_dv_returnedpurchase_z_l_bill_revoke);
//        btn_p_dv_returnedpurchase_z_l_bill_revoke.setOnClickListener(new View.OnClickListener() {
//
//            @Override
...
//        });
    ...
    private void showPopBatchView() {
        ...
        View list = LayoutInflater.from(this).inflate(
                R.layout.new_p_dv_returnedpurchase_z_l_bill, null);
        if (mPopWindow == null) {
...
//                }else{
                    ...
                    showbatch_num=batch_num;
                    tv_text_batch.setText("批号："+showbatch_num);
                    ed_code.setText("");
                    WindowManager.LayoutParams lp = getWindow().getAttributes();
                    lp.alpha = 1f;
                    getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case ShowMessage.HandScanSuccess:
                    ...
                    if (sysUserInfo.getEnterpriseId().equals("00")||sysUserInfo.getEnterpriseId().equals("08")) {
                        tv_text_batch.setText(showbatch_num);
                    }
                ...
                case 8:
                    ...
                    mark[2] = "直营店：" + tv_company_name.getText().toString();
                    mark[3] = "仓   库 ：" + tv_stock_name.getText().toString();

                    printbill.print(P_Dv_ReturnedPurchase_Z_L_Bill.this, "      有单无明细直销退货", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_Bill", para.toJson());
