...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_L_Bill_Cancel
 * @Description: 有单无明细直营退货撤销
 * @Author: lijin
 * @Date: 2021/3/10 10:23
 */
public class P_Dv_ReturnedPurchase_Z_L_Bill_Cancel extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    mark[0] = "退货单：" + mBillNo;
                    printbill.print(P_Dv_ReturnedPurchase_Z_L_Bill_Cancel.this, " 有单无明细直销退货撤销", mark, sacnDataList, sysUserInfo.getUserid());
