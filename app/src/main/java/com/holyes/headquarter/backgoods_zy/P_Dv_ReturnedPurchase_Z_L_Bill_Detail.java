...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_L_Bill_Detail
 * @Description: 有单有明细直销退货
 * @Author: lijin
 * @Date: 2021/3/10 10:23
 */
public class P_Dv_ReturnedPurchase_Z_L_Bill_Detail extends Activity {
    ...
    private TextView tv_curqty, tv_totalqty, tv_company_name, tv_source_billno, tv_title,
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedPurchase_Z_L_Bill_Detail.this, "     有单有明细直销退货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_Bill_Detail", para.toJson());
