...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_L_Bill_Detail_Cancel
 * @Description: 有单有明细直销退货撤销
 * @Author: lijin
 * @Date: 2021/3/10 10:24
 */
public class P_Dv_ReturnedPurchase_Z_L_Bill_Detail_Cancel extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    mark[0] = "退货单：" + mBillNo;
                    printbill.print(P_Dv_ReturnedPurchase_Z_L_Bill_Detail_Cancel.this, " 有单有明细直销退货撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_Bill_Detail_Cancel", para.toJson());
