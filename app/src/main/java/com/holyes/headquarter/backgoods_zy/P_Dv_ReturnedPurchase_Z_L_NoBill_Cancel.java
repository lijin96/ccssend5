        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedPurchase_Z_L_NoBill_Cancel.this, "     无单直销退货撤销", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_NoBill_Cancel", para.toJson());
