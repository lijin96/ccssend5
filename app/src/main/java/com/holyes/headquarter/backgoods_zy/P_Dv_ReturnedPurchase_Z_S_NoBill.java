...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_S_NoBill
 * @Description: 无单(直营分店)退货
 * @Author: lijin
 * @Date: 2021/3/10 10:24
 */
public class P_Dv_ReturnedPurchase_Z_S_NoBill extends Activity {
    ...
    private Button btn_p_dv_returnedpurchase_z_s_nobill_revoke;
    private PopupWindow mPopWindow;

    private StoreInfor infor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_dv_returnedpurchase_z_s_nobill);

        mContext = this;
        accWeb = new AccessWeb(this);
        handler = new MyHandler();
        gIntent = getIntent();
        infor = (StoreInfor) getIntent().getSerializableExtra("selectedStoreInfor");
        ...
        tv_curqty.setText("0");
        tv_billno.setText("");
        tv_company_name.setText(infor.getStoreName());
        tv_stock_name.setText(stock_name);

        //		send = new SendDatas();
        //		send.start();

        btn_p_dv_returnedpurchase_z_s_nobill_revoke = (Button) findViewById(R.id.btn_p_dv_returnedpurchase_z_s_nobill_revoke);
        btn_p_dv_returnedpurchase_z_s_nobill_revoke.setOnClickListener(new View.OnClickListener() {
    ...
    private void showPopListView() {
        ...
        View list = LayoutInflater.from(this).inflate(
                R.layout.activity_p_dv_returnedpurchase_z_s_nobill, null);
        if (mPopWindow == null) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_ReturnedPurchase_Z_S_NoBill.this, "       无单直营分销退货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    para.setGoodsId("");
                    para.setSoCompId(infor.getTraderId());
                    para.setDeCompId("00");
                    para.setOaSuserId(sysUserInfo.getUserid());
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Z_L_NoBill", para.toJson());
