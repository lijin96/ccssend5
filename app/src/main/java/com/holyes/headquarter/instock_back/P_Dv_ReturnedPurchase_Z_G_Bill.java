...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_G_Bill
 * @Description: 有单入库退回
 * @Author: lijin
 * @Date: 2021/3/10 11:03
 */
public class P_Dv_ReturnedPurchase_Z_G_Bill extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_g_bill);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    mark[0] = "入库单：" + mBillNo;
                    mark[1] = "品检单：" + tv_source_billno.getText().toString();
                    mark[2] = "供应商：" + tv_company_name.getText().toString();
                    mark[3] = "仓   库 ：" + tv_stock_name.getText().toString();

                    printbill.print(P_Dv_ReturnedPurchase_Z_G_Bill.this, "         有单入库退回", mark, sacnDataList, sysUserInfo.getUserid());
