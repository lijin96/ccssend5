...
/**
 * @ClassName: P_Dv_L_Return_Z_Bill
 * @Description: 代理退货直通车
 * @Author: lijin
 * @Date: 2021/3/10 14:01
 */
public class P_Dv_L_Return_Z_Bill extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_l_return_z_bill);
...
//				tv_goodsid.setText("("+goodsid+")");
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_L_Return_Z_Bill.this, "     退货直通车", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_L_Return_Z_Bill", para.toJson());
