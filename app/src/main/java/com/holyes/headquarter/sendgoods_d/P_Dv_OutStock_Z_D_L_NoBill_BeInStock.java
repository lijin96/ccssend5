 ...
 * @Description: 无单有入库代发零售函数
 * @Author: lijin
 * @Date: 2025年8月6日09:28:26
 */
public class P_Dv_OutStock_Z_D_L_NoBill_BeInStock extends Activity {
    ...
    private String scanBillno = "", mBillNo = "", company_id = "", supplier_name = "",mAgentBillNo="";
    ...
    private String RetailerId="",RetailerName="";//零售商代号 零售商名称
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_d_l_nobill_beinstock);
                ...
                case ShowMessage.HandScanSuccess:
                    ...
                    if (sysUserInfo.getChange()) {
                        if (!tv_model_colors.getText().toString().equals("")) {
                            if (!GoodsType.equals(tv_model_colors.getText().toString())) {
                                MySound.errorChange();
                                SomeUtils.ShowAlertdialog(mContext, GoodsType);
...
//                    mark[3] = "仓   库 ：" + tv_stock_name.getText().toString();
                    ...
                    printbill.print(P_Dv_OutStock_Z_D_L_NoBill_BeInStock.this, "无单有入库代销零售发货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case Lic_SelectModel:
                    RetailerId=data.getStringExtra("company_id");
                    RetailerName=data.getStringExtra("company_na");
                    tv_retail_name.setText(RetailerName);
                    break;
            }
        }
...
//                    OutBoxCode：发货装箱条码(非必传)
                    ...
                    para.setBatchno("");
                    para.setDocumentNo(mAgentBillNo);
                    para.setOutBoxCode("");

                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_D_L_NoBill_BeInStock", para.toJson());
                    ...
                    if (contents.startsWith("P")) {
                        ...
                        for (int i = 0; i < listjson.length(); i++) {
                            ...
                            GoodsType = jsonObject2.getString("Modelm") + "-" + jsonObject2.getString("Colors");
...
//                            mAgentBillNo =jsonObject1.optString("");
                        }
                    }else {
                        ...
                        GoodsType = rest[1].trim() + "-" + rest[2].trim();
