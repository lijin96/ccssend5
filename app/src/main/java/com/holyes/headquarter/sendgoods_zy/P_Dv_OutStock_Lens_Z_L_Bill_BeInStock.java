 ...
 * @Description: 镜片有单有入库直销发货
 * @Author: lijin
 * @Date: 2024年6月13日15:12:52
 */
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    printbill.printLens(P_Dv_OutStock_Lens_Z_L_Bill_BeInStock.this, "镜片有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_L_Lens_Bill_BeInStock", para.toJson());
//                    Log.d("main",result);
                    if (result == "") {
                        MySound.errorSound();
                        ShowMessage.ShowMsg(handler, "网络不给力，请稍后再试！");
