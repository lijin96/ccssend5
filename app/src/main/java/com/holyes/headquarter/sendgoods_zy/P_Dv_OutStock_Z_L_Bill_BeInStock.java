        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_OutStock_Z_L_Bill_BeInStock.this, "    有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_L_Bill_BeInStock", para.toJson());
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if (keyCode == KeyEvent.KEYCODE_ENTER) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    if (et_barcode.getText().toString().trim().equals("")) {
                        MySound.errorSound();
