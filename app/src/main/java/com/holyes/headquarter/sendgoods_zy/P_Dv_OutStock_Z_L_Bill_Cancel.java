        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_OutStock_Z_L_Bill_Cancel.this, "     有单直销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_L_Bill_Cancel", para.toJson());
