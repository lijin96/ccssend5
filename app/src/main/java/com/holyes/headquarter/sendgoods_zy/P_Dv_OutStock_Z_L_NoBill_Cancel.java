...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBillno = sysUserInfo.getUserid() + "CZF" + SomeUtils.RandomScanOrder();// 系统
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_OutStock_Z_L_NoBill_Cancel.this, "     无单直销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_L_NoBill_Cancel", para.toJson());
