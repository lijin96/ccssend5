...
/**
 * @ClassName: P_Dv_OutStock_Z_L_S_HaveBill_BeInStock
 * @Description: 总公司有单有入库直销分店发货
 * @Author: lijin
 * @Date: 2022/12/16 10:09
 */
public class P_Dv_OutStock_Z_L_S_HaveBill_BeInStock extends Activity {
...
//	private List<String> codesList= new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_l_s_havebill_beinstock);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_OutStock_Z_L_S_HaveBill_BeInStock.this, "  有单有入库直销分店发货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_Z_L_S_HaveBill_BeInStock", para.toJson());
                    ...
                    if (contents.startsWith("P")) {
                        ...
                        //true;产品编号,型号,色号,当前型号数量,当前扫描的条码,直销客户单据编号,直分店单据编号,当前扫描数量
                        String[] rest = result.split(",",-1);
                        ...
                        //产品编号,型号,色号,当前型号数量,当前扫描的条码,直销客户单据编号,直分店单据编号,当前扫描数量
                        goodsid = rest[0].trim();
                        modelm = rest[1].trim();
                        colors = rest[2].trim();
