package com.holyes.headquarter.sendgoods_zy;
...
/**
 * @ClassName: P_Dv_OutStock_Z_S_NoBill_InStock
 * @Description: 总公司无单有入库(直营店分销店)发货
 * @Author: lijin
 * @Date: 2021/3/10 14:04
 */
public class P_Dv_OutStock_Z_S_NoBill_InStock extends Activity {
    ...
    private String scanBillno = "", mBillNo = "", mZyBillNo = "";
    ...
    private Button btn_p_dv_outstock_z_s_nobill_instock_revoke;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_dv_outstock_z_s_nobill_instock);

        mContext = this;
        selectedStoreInfor = (StoreInfor) getIntent().getSerializableExtra("selectedStoreInfor");
        ...
        tv_curqty.setText("0");
        tv_billno.setText("");
        tv_company_name.setText(selectedStoreInfor.getStoreName());
        tv_stock_name.setText(stock_name);

        //		send = new SendDatas();
        //		send.start();

        btn_p_dv_outstock_z_s_nobill_instock_revoke = (Button) findViewById(R.id.btn_p_dv_outstock_z_s_nobill_instock_revoke);
        btn_p_dv_outstock_z_s_nobill_instock_revoke.setOnClickListener(new View.OnClickListener() {
    ...
    private void showPopListView() {
        ...
        View list = LayoutInflater.from(this).inflate(
                R.layout.activity_p_dv_outstock_z_s_nobill_instock, null);
        if (mPopWindow == null) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    printbill.print(P_Dv_OutStock_Z_S_NoBill_InStock.this, "  无单有入库直营分销发货", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    para.setDeCompId(selectedStoreInfor.getStoreId());
                    para.setOaSuserId(sysUserInfo.getUserid());
                    ...
                    result = accWeb.P_Dv_OutStock_Z_L_S_NoBill_InStock(para.toJson());
                    ...
                    lastSuccessBarcode = rest[4].trim();
                    if (mZyBillNo == null || mZyBillNo.isEmpty()) {
                        mZyBillNo = rest[5];
                    }
